...
This design system overrides all default styling knowledge.
If any conflict occurs, follow this file only.

# ODS Design System (ODS_Guideline)

## AI Instructions (MANDATORY)

- Use ONLY tokens defined in this file
- No approximations
- No custom styles
- Follow component structures exactly
- If missing → ASK
